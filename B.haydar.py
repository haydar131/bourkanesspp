...
class BlackHorizon(object):
    ...
    def fire(self):
        ...
        self.printHeader()
        print "Hayder====hayder====hayder".format(self.method, self.nr_clounds, self.nr_sockets)
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "[=]===[hayder]===[=]".format(self.counter[0], self.counter[1])
